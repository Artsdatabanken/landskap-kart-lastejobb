...
gdal_rasterize -ot Byte -a_ullr -2500000 9045984 3045984 3500000 -burn 0 -burn 0 -burn 0 -outsize 140000 140000 -of GTiff $prefix.geojson $prefix.tif
...
gdal_translate  -co "ZOOM_LEVEL_STRATEGY=upper" -ot Byte -r nearest -of MBTILES -co RESAMPLING=NEAREST $prefix.tif $prefix.mbtiles
